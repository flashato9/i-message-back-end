...
apiAuth.route("/sign-in/:username/reset-password").patch(resetPasswordPost);
apiAuth.route("/sign-in/:username/reset-password/confirmation-code").get(resetPasswordConfirmationCodeGet);
apiAuth.post("/sign-up", signUpPost);
apiAuth.route("/sign-up/:username/confirm-code").get(signUpConfirmationCodeGet).patch(signUpConfirmationCodePost);
